...
class SI_Parcelas_ContratoModel extends Model
{
	...
	protected $allowedFields = [
		'id_contrato', 'tipo_lancamento', 'numero_parcela', 'descricao', 
		'data_emissao', 'data_vencimento', 'valor_parcela', 'valor_desconto', 
		'valor_juros', 'valor_multa', 'status',
		// Campos de configuração de boleto
		'juros_percentual', 'multa_percentual', 'multa_apos_dias', 
		'desconto_percentual', 'nao_receber_apos_dias', 'protestar_apos_dias',
		'aceite', 'tipo_titulo', 'mensagem_banco'
	];
