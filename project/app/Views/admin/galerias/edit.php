        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <?= form_open(base_url('Admin/Galerias/editar'.'/'.$field->id)) ?>
              <?= csrf_field() ?>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-8">
                          ...
                          <div class="form-group">
                            ...
                            <div class="image_area">
                                <label for="upload_image">
                                  <img src="<?= !empty($field->capa)? base_url('uploads/img/'.$field->capa): base_url('assets/dist/img/imagem-1.jpg');?>" id="uploaded_image" class="img-fluid w-100" />
                                  <div class="overlay">
