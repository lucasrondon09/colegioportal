        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('Admin/Turma/alunos').'/'.$idTurma?>">Alunos</a></li>
              <li class="breadcrumb-item active">Adicionar Alunos</li>
            </ol>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header d-flex align-items-center">
                ...
                <div class="ml-auto">
                <?= form_open(base_url('Admin/Turma/adicionar-alunos').'/'.$idTurma) ?>
                <?= csrf_field() ?>
                  ...
                  <?php foreach($table as $tableItem):?>
                    <tr>
                      ...
                      <td style="width: 10%;" class="text-center">
                        <a href="<?= base_url('Admin/Turma/setAluno').'/'.$idTurma.'/'.$tableItem->id;?>" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" title="Adicionar">
                          Adicionar
                        </a>
                      </td>
                    </tr>
