        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <?php if(!empty($idPai)):?>
                <li class="breadcrumb-item"><a href="<?= base_url('Admin/Pais')?>">Ano Letivo</a></li>
              <?php endif;?>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <?php
                ...
                <?php endif;?>
                <?= form_open(base_url('Admin/Ano-Letivo')) ?>
                <div class="input-group">
                  <select class="custom-select" name="anoLetivo">
                    <?php foreach($listaAnos as $listaAnosItem):?>
                      <?php $anoLetivo = (new SI_ParametroModel())->getAnoLetivo()?>
                    <option value="<?= $listaAnosItem?>" <?= $listaAnosItem == $anoLetivo ? 'selected' : '';?>><?= $listaAnosItem?></option>
                    <?php endforeach;?>
                  </select>
