        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('Admin/Paginas-Internas').'/'.$pagina->id?>"><?= $pagina->descricao?></a></li>
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <h3 class="card-title mt-3">
                <a href="<?= base_url('Admin/Paginas-Internas').'/'.$pagina->id?>" class="text-decoration-none text-dark">
              ...
              <?= form_open_multipart(base_url('Admin/Paginas-Internas/save')) ?>
              <?= csrf_field() ?>
                <input type="text" hidden name="paginaId" value="<?= $pagina->id?>">
                <div class="card-body">
