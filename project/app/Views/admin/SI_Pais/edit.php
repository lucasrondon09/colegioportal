          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <h3 class="card-title mt-3">
                <a href="<?= base_url('/Admin/Pais/detalhes/'.$field->id)?>" class="text-decoration-none text-dark">
              ...
              <?= form_open(base_url('Admin/Pais/editar').'/'.$field->id) ?>
              <?= csrf_field() ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="rm_pai_nacionalidade" value="<?= $field->rm_pai_nacionalidade?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nasc_mae" value="<?= $field->nasc_mae; ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="rm_mae_nacionalidade" value="<?= $field->rm_mae_nacionalidade;?>">
                  </div>
                  <div class="form-group">
