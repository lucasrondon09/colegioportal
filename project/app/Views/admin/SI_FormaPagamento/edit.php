        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <?= form_open(base_url('Admin/SI_FormaPagamento/editar/'.$field->id)) ?>
              <?= csrf_field() ?>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               id="nome" 
                               name="nome" 
                               value="<?= set_value('nome', $field->nome) ?>"
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               value="<?= set_value('taxa_percentual', $field->taxa_percentual) ?>"
                               step="0.01"
                               min="0"
                               max="100">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               value="<?= set_value('prazo_compensacao', $field->prazo_compensacao) ?>"
                               min="0">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" 
                                  ...
                                  name="descricao" 
                                  rows="3"
                                  placeholder="Descrição detalhada da forma de pagamento"><?= set_value('descricao', $field->descricao) ?></textarea>
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               id="ordem_exibicao" 
                               name="ordem_exibicao" 
                               value="<?= set_value('ordem_exibicao', $field->ordem_exibicao) ?>"
                               min="0">
                      ...
                      <div class="form-group">
                        <div class="custom-control custom-switch">
                          <input type="checkbox" 
                                 ...
                                 name="ativo" 
                                 value="1"
                                 <?= set_checkbox('ativo', '1', $field->ativo); ?>>
                  ...
                  <div class="row mt-3">
                    <div class="col-md-12">
                      <div class="alert alert-info">
                        ...
                        Criado em: <?= date('d/m/Y H:i', strtotime($field->created_at)) ?><br>
                        Última atualização: <?= date('d/m/Y H:i', strtotime($field->updated_at)) ?>
                      </div>
                    </div>
                  </div>
                </div>
