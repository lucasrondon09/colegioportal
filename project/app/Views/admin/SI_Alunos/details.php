          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <h3 class="card-title mt-3">
                <a href="<?= session()->sistema == 'sispai'  ? base_url('/Admin/Alunos/'.session()->userId) : base_url('/Admin/Alunos/')?>" class="text-decoration-none text-dark">
              ...
              <form>
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <label class="col-form-label col-sm-2">Matricula</label>
                    <input type="text" class="form-control-plaintext col-sm-1" name="matricula" value="<?= $field->matricula;?>">
                    <label class="col-form-label col-sm-2">Data Matricula</label>
