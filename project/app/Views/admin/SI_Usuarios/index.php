...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            <a href="<?= base_url('Admin/Usuarios/cadastrar')?>" class="btn btn-primary">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header d-flex align-items-center">
                ...
                <div class="ml-auto">
                <?= form_open(base_url('Admin/Usuarios'), ['method' => 'get']) ?>
                ...
                <table id="registros" class="table table-bordered table-hover mb-3">
                  ...
                  <?php foreach($table as $tableItem):?>
                    <tr>
                      ...
                      <td><?= $tableItem->usuario?></td>
                      <td><?= $permissao[$tableItem->permissao]?></td>
                      <td class="text-center">
                      <a href="<?= base_url('Admin/Usuarios/visualizar').'/'.$tableItem->id;?>" class="btn btn-sm btn-outline-primary" data-toggle="tooltip" data-placement="top" title="Visualizar">
                        <i class="fas fa-eye"></i>
                      </a>

                      <a href="<?= base_url('Admin/Usuarios/editar').'/'.$tableItem->id;?>" class="btn btn-sm btn-outline-info" data-toggle="tooltip" data-placement="top" title="Editar">
