        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('Admin/Email')?>">Email</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <?= form_open(base_url('Admin/Email/editar').'/'.$field->id) ?>
              <?= csrf_field() ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="nome">Email</label>
                    <input type="text" class="form-control" id="assunto" name="assunto" value="<?= $field->assunto;?>">
                  </div>
                </div>
                <!-- /.card-body -->
