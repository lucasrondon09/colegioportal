          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header d-flex align-items-center">
                ...
                <div class="ml-auto">
                <?= form_open(base_url('Admin/Email')) ?>
                <?= csrf_field() ?>
                ...
                <table id="registros" class="table table-bordered table-hover mb-3">
                  ...
                  <?php foreach($table as $tableItem):?>
                    <tr>
                      ...
                      <td><?= $tableItem->assunto?></td>
                      <td class="text-center" width="10%">
                      <a href="<?= base_url('Admin/Email/editar').'/'.$tableItem->id;?>" class="btn btn-sm btn-outline-info" data-toggle="tooltip" data-placement="top" title="Editar">
                        <i class="fas fa-pen fa-fw"></i>
                      </a>
                      
                      <a href="<?= base_url('Admin/Email/excluir').'/'.$tableItem->id;?>" class="btn btn-sm btn-outline-danger" data-toggle="tooltip" data-placement="top" title="Excluir" onClick="return deletar()">
