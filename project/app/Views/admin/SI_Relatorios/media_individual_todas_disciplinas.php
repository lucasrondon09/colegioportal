...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Média Individual - Todas as Disciplinas</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('Admin/home')?>">Home</a></li>
              <li class="breadcrumb-item active">Média Individual - Todas as Disciplinas</li>
            </ol>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <?php
                ...
                <div class="row">
                  <div class="col-md-12">
                    <?= form_open(base_url('Admin/Relatorios/media-individual-todas-disciplinas/send')) ?>
