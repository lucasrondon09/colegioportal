              ...
              <?= csrf_field() ?>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="nome" class="form-control" id="nome" name="nome" value="<?= $field->nome;?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Login</label>
                    <input type="text" name="login" class="form-control" id="login" name="login" value="<?= $field->login;?>">
                  </div>
                  <div class="form-group">
