        ...
        <div class="row d-flex justify-content-center py-5">
            <div class="col-md-6 d-flex align-items-center bg-white rounded text-center justify-content-center">
                <div class="">
                    ...
                    <h3 class="text-primary mt-2 custom-h1">Agendamento de Consultas</h3>
            ...
            <div class="col-md-6 px-4">
                ...
                <div class="mt-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="assunto" value="Agendamento de Consulta" hidden>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="email" class="form-label fw-bold text-secondary">Médico</label>
                        <select class="form-select border-primary"  id="medico" name="medico" required>
                        <option selected disabled value="">Selecione</option>
                        <?php foreach($medico as $medicoItem):?>
                        <option value="<?= $medicoItem->titulo?>"><?= $medicoItem->titulo?></option>
                        <?php endforeach;?>
                        </select>
                    </div>
                    <div class="mb-3">
