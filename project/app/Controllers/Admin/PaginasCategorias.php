...
class PaginasCategorias extends Controller
{
    protected $model;
    protected $session;
    ...
    public function __construct()
	{
		...
		$this->model	= new PaginasCategoriaModel();
    ...
    public function index()
    {
        ...
        echo view('admin/paginas-categoria/index.php', $this->data);
    ...
    public function create()
    {
        ...
        if($this->request->getMethod() === 'post'){
            ...
            if(csrf_hash() === $this->request->getVar('csrf_test_name'))
            {
                ...
                if ($this->validation->withRequest($this->request)->run()){
                    ...
                    return redirect()->to('/Admin/PaginasCategorias/cadastrar');
                }
        ...
        echo view('admin/template/header.php');
        echo view('admin/template/sidebar.php');
        echo view('admin/paginas-categoria/create.php');
        echo view('admin/template/footer.php');
    ...
    public function edit($id)
    {
        ...
        if($this->request->getMethod() === 'post'){
            ...
            if ($this->validation->withRequest($this->request)->run()){
                ...
                $this->session->setFlashdata($alert, $message);
                return redirect()->to('/Admin/PaginasCategorias/editar/'.$id);
        ...
        echo view('admin/template/header.php');
        echo view('admin/template/sidebar.php');
        echo view('admin/paginas-categoria/edit.php', $this->data);
        echo view('admin/template/footer.php');
    ...
    public function delete($id)
    {
        ...
        $this->session->setFlashdata($alert, $message);
        return redirect()->to('/Admin/PaginasCategorias');
