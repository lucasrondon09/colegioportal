...
// Rotas de Boletos
//-------------------------------------------------------------------------
$routes->get('/Admin/Lancamentos/gerarBoleto/(:num)', 'Admin\SI_Lancamentos::gerarBoleto/$1');
$routes->get('/Admin/Lancamentos/visualizarBoleto/(:num)', 'Admin\SI_Lancamentos::visualizarBoleto/$1');
$routes->get('/Admin/Lancamentos/imprimirBoleto/(:num)', 'Admin\SI_Lancamentos::imprimirBoleto/$1');

// Rotas de Configuração de Boletos
//-------------------------------------------------------------------------
$routes->get('/Admin/Boleto-Config', 'Admin\SI_ConfiguracoesBoleto::index');
$routes->post('/Admin/Boleto-Config/salvar', 'Admin\SI_ConfiguracoesBoleto::salvar');
$routes->get('/Admin/Boleto-Config/restaurar-padrao', 'Admin\SI_ConfiguracoesBoleto::restaurarPadrao');
$routes->get('/Admin/Boleto-Config/testar', 'Admin\SI_ConfiguracoesBoleto::testar');

// Rotas de CNAB - Remessas
//-------------------------------------------------------------------------
$routes->get('/Admin/Cnab-Remessa', 'Admin\SI_CnabRemessa::index');
$routes->get('/Admin/Cnab-Remessa/Nova', 'Admin\SI_CnabRemessa::nova');
$routes->post('/Admin/Cnab-Remessa/Gerar', 'Admin\SI_CnabRemessa::gerar');
$routes->get('/Admin/Cnab-Remessa/Visualizar/(:num)', 'Admin\SI_CnabRemessa::visualizar/$1');
$routes->get('/Admin/Cnab-Remessa/Download/(:num)', 'Admin\SI_CnabRemessa::download/$1');
$routes->post('/Admin/Cnab-Remessa/MarcarEnviada/(:num)', 'Admin\SI_CnabRemessa::marcarEnviada/$1');
$routes->post('/Admin/Cnab-Remessa/Excluir/(:num)', 'Admin\SI_CnabRemessa::excluir/$1');

// Rotas de CNAB - Retornos
//-------------------------------------------------------------------------
$routes->get('/Admin/Cnab-Retorno', 'Admin\SI_CnabRetorno::index');
$routes->get('/Admin/Cnab-Retorno/Upload', 'Admin\SI_CnabRetorno::upload');
$routes->post('/Admin/Cnab-Retorno/Processar', 'Admin\SI_CnabRetorno::processar');
$routes->get('/Admin/Cnab-Retorno/Visualizar/(:num)', 'Admin\SI_CnabRetorno::visualizar/$1');
$routes->get('/Admin/Cnab-Retorno/Download/(:num)', 'Admin\SI_CnabRetorno::download/$1');
$routes->post('/Admin/Cnab-Retorno/Reprocessar/(:num)', 'Admin\SI_CnabRetorno::reprocessar/$1');
$routes->post('/Admin/Cnab-Retorno/Excluir/(:num)', 'Admin\SI_CnabRetorno::excluir/$1');
$routes->get('/Admin/Cnab-Retorno/Exportar/(:num)', 'Admin\SI_CnabRetorno::exportar/$1');
